...
//		if (userType == 1) {
//			String sql = "from Admin where identity = '抄表员' and username=? and userpwd=?";
//			Object[] con = { userName, userPw };
...
//	}
		...
		if (userType == 2)//
		{
			String sql = "from Admin where identity = '业务员' and username=? and userpwd=?";
			Object[] con = { userName, userPw };
			List adminList = adminDAO.getHibernateTemplate().find(sql, con);
			if (adminList.size() == 0) {
				result = "no";
