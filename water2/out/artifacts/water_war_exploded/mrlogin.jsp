...
<%--            	<div class="panel-foot text-center" target="_blank"><a href="<%=path %>/login.jsp">管理员角色登录</a> </div>--%>
<%--            </div>--%>
<%--            </form>--%>
<%--            --%>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function check1()
        {
            ...
            loginService.login(document.loginForm.userName.value,document.loginForm.userPw.value,1,callback);
        }
        ...
        <div class="x4 x4-move ">
            ...
            <form name="loginForm" id="loginForm" method="POST" action="">
                <div class="panel loginbox">
                    <div class="text-center margin-big padding-big-top"><h1>自来水分公司水费系统(抄表员)</h1></div>
                    ...
                    <div class="panel-foot text-center" target="_blank"><a href="<%=path %>/userlogin.jsp">普通用户登录</a></div>
                </div>
            </form>
