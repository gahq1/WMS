...
<%--			</ul>--%>
		...
		<ul>
			<li><a href="<%=path%>/shoufei!listpage.action"
				   target="right"><span class="icon-caret-right"></span>修改支付状态</a></li>
			<li><a href="<%=path %>/shoufei!toadd.action"
				   target="right"><span class="icon-caret-right"></span>打印小票</a></li>
		</ul>
		</c:if>
        ...
        <ul>
            <li><a href="<%=path %>/admin/userinfo/ordinaryPw.jsp"
                   target="right"><span class="icon-caret-right"></span>密码修改</a></li>
			<li><a href="<%=path %>/user!listpage.action"
				   target="right"><span class="icon-caret-right"></span>个人信息修改</a></li>
		</ul>
		<h2>
			<span class="icon-user"></span>用水缴费信息
		</h2>
		<ul>
			<li><a href="<%=path %>/admin/userinfo/ordinaryPw.jsp"
				   target="right"><span class="icon-caret-right">用水缴费信息查看</span></a></li>
		</ul>
		</c:if>
	</div>
